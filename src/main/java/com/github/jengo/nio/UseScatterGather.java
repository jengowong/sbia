...
public class UseScatterGather {
    ...
    static private final int firstHeaderLength = 3;
    static private final int secondHeaderLength = 4;
    static private final int bodyLength = 5;
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (true) {
            ...
            while (bytesRead < messageLength) {
                ...
                System.out.println("rBytes=" + r);
                for (int i = 0; i < buffers.length; ++i) {
                    ByteBuffer bb = buffers[i];
                    System.out.println("b[" + i + "] pos=" + bb.position() + " lim=" + bb.limit());
                }
            }
            ...
            System.out.println("rBytes=" + bytesRead + " wBytes=" + bytesWritten + " msgLen=" + messageLength);
        }
    }
